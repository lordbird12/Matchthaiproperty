...
export class Service {
    ...
    new(data: any): Observable<any> {
        ...
        return this._httpClient
            .post(
                environment.API_URL + '/api/vendor_company',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update(data: any): Observable<any> {
        ...
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_vendor_company',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/vendor_company_page',
                dataTablesParameters,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getVendor(data:any): Observable<any> {
        return this._httpClient.post<DataUser>(
            environment.API_URL + '/api/get_vendor',
            data,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/vendor-company/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
}
