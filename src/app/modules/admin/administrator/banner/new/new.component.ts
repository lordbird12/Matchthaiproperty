...
export class NewComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    positionData: any = [
        ...
        { value: 'banner_home_4', name: 'Banner Home 4 (Banner)' },
        { value: 'banner_search', name: 'Banner Search (Banner)' },
        { value: 'banner_search2', name: 'Banner Search 2 (Banner)' },
        { value: 'banner_news', name: 'Banner News (Banner)' },
        { value: 'banner_news2', name: 'Banner News 2 (Banner)' },
        { value: 'banner_course', name: 'Banner Course (Banner)' },
        { value: 'banner_course2', name: 'Banner Course 2 (Banner)' },
        { value: 'banner_aboutus', name: 'Banner About us (Banner)' },
        { value: 'banner_contact', name: 'Banner Contact (Banner)' },
        { value: 'banner_partner', name: 'Banner Partner (Banner)' },
