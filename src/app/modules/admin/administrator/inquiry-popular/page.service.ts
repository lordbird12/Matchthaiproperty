...
export class Service {
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.get(environment.API_URL + '/api/inquiry_tag_popular', dataTablesParameters).pipe(
          switchMap((response: any) => {
    ...
    Page(){
        return this._httpClient.get(environment.API_URL + '/api/inquiry_tag_popular').pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
