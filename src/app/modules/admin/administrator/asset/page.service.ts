...
export class Service {
     ...
     * Get comment
     */
    followstatus(Id: any, data: FormData): Observable<any> {
        return this._httpClient
            .put(environment.API_URL + `/api/approve_asset/${Id}`, data)
            .pipe();
    }
    ...
    new(data: any): Observable<any> {
        ...
        return this._httpClient
            .post(
                environment.API_URL + 'api/course_lesson',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getConfirm(): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/approve_asset')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getById(Id: string): Observable<DataBank> {
        return this._httpClient.get<DataBank>(
            environment.API_URL + '/api/get_asset_by_id/' + Id
        );
    }
    ...
    update(data: any, id: any): Observable<any> {
        return this._httpClient
            .put(
                environment.API_URL + 'api/course_lesson/' + id,
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    updateConfirm(data: any, id: any): Observable<any> {
        return this._httpClient
            .put(
                environment.API_URL + '/api/approve_asset/' + id,
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/asset_back_office_page',
                dataTablesParameters,
                this.httpOptionsFormdata
            )
            .pipe(
