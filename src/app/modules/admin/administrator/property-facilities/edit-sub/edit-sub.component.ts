...
export class EditSubComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    async ngOnInit(): Promise<void> {
        ...
        this._Service.getBySubId(this.Id).subscribe((resp: any) => {
            ...
            this.formData.patchValue({
                ...
                property_sub_facility_id: this.itemData.property_sub_facility_id,
    ...
    updateSub(): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.updateSub(this.formData.value,this.Id).subscribe({
                    next: (resp: any) => {
                        this.showFlashMessage('success');
                        this._router
                            .navigateByUrl('property-facilities/add/'+this.formData.value.property_sub_facility_id)
                            .then(() => {});
                    },
                    error: (err: any) => {
