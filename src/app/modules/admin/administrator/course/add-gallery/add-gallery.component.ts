...
export class AddGalleryComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                that._Service
                    .getGalleryPage(dataTablesParameters)
                    .subscribe((resp) => {
    ...
    createCoupon(): void {
        ...
        confirmation.afterClosed().subscribe(async (result) => {
            if (result === 'confirmed') {
                ...
                const file = await lastValueFrom(this._Service.uploadVideo(image))
                this.formData.patchValue({image:file})
           

                this._Service.newGallery(this.formData.value).subscribe({
                    next: (resp: any) => {
                        // this._router
    ...
    DeleteGallery(id: any): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            if (result === 'confirmed') {
                this._Service.deleteGallery(id).subscribe({
                    next: (resp: any) => {
                        location.reload();
                    },
                    error: (err: any) => {
    ...
    edit(Id: string): void {
        this._router.navigate(['course/edit-gallery/' + Id]);
    }
