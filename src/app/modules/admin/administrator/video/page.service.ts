...
export class Service {
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/get_manual_by_id/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any, id): Observable<any> {
        return this._httpClient
            .put(
                environment.API_URL + '/api/manual/' + id,
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + '/api/manual_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
          switchMap((response: any) => {
