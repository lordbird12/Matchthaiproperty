...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.formData = this._formBuilder.group({
            news_type_id: [null, Validators.required],
   
        });
       
        this._Service.getNewsTypeId().subscribe((resp: any) => {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                dataTablesParameters.news_type_id= this.formData.value.news_type_id;
                if(!!dataTablesParameters.news_type_id)
                {               
                     that._Service
